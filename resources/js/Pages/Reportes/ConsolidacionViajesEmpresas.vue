...
const generarReporte = () => {
    ...
    const url = route("reportes.r_consolidacion_viajes_empresas", form.value);
...
<template>
    <Head title="Reporte Consolidación de viajes por Empresas"></Head>
    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">
            Reportes > Consolidación de viajes por Empresas
        </li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reportes > Consolidación de viajes por Empresas</h1>
    <!-- END page-header -->
    <div class="row">
