...
const generarReporte = () => {
    ...
    const url = route("reportes.r_consolidacion_viajes_facturacion", form.value);
...
<template>
    <Head title="Reporte Consolidación de viajes para facturación"></Head>
    <!-- BEGIN breadcrumb -->
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:;">Inicio</a></li>
        <li class="breadcrumb-item active">
            Reportes > Consolidación de viajes para facturación
        </li>
    </ol>
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Reportes > Consolidación de viajes para facturación</h1>
    <!-- END page-header -->
    <div class="row">
