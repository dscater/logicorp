...
const { getConductors, setConductor, limpiarConductor, deleteConductor } =
    useConductors();
...
const columns = [
    ...
    {
        title: "FECHA EMISIÓN",
        data: "fecha_emision_t",
    },
    {
        title: "FECHA VENCIMIENTO",
        data: "fecha_vencimiento_t",
    },
    {
        title: "TELÉFONO",
        data: "fono",
...
const accionesRow = () => {
    // editar
    $("#table-conductor").on("click", "button.editar", function (e) {
        e.preventDefault();
        let id = $(this).attr("data-id");
        axios.get(route("conductors.show", id)).then((response) => {
    ...
    // eliminar
    $("#table-conductor").on("click", "button.eliminar", function (e) {
        e.preventDefault();
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let respuesta = await deleteConductor(id);
