...
const { getPagos, setPago, limpiarPago, deletePago, oPago } = usePagos();
...
const agregarRegistro = () => {
    limpiarPago();
    oPago.value.programacion_id = props.programacion.id;
    oPago.value.programacion = props.programacion;
...
onMounted(async () => {
    datatable = initDataTable(
        "#table-pago",
        columns,
        route("pagos.api", props.programacion.id)
    );
...
<template>
    ...
    <!-- END breadcrumb -->
    <!-- BEGIN page-header -->
    <h1 class="page-header">Programación > Pagos</h1>
    <!-- END page-header -->
